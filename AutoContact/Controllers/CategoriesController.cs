...
namespace AutoContact.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(AutoContactContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(long? id)
        {
            ...
            var client = await _context.Categories
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("CategoryId,Category")] Category category)
        {
